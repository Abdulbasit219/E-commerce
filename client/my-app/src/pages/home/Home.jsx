            ...
            <div className='flex flex-wrap m-2'>
                ...
                <div className='w-[20%] border-2 hidden md:inline'>
                    ...
                    <div className='relative text-center'>
                        <input type="text" className='border p-2 rounded w-[90%] mt-2' placeholder='Search' />
                        <FaSearch className='absolute right-8 top-1/2 text-xl transform -translate-y-1/3' />
                    </div>
