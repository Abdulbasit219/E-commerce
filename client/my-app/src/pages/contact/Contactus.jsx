          ...
          <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
            <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
              ...
              <div>
                ...
                <Link className="mt-2 text-sm text-blue-500 dark:text-blue-400">abdulbasitbasit076@gmail.com</Link>
              </div>
              ...
              <div>
                ...
                <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">Mon-Fri from 9am to 5pm.</p>
                <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">+92 316 2956262</p>
              </div>
