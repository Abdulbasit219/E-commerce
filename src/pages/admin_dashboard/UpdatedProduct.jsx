...
const UpdatedProduct = () => {
    ...
    const getPhoto = async () => {
        try {
            const response = await axios.get(`https://api-to2k.onrender.com/api/v1/product/get-productphoto/${id}`);
        } catch (error) {
            console.log(error)
        }
    }
    ...
    const updateProduct = async (e) => {
        ...
        try {
            ...
            const { data } = await axios.put(`https://api-to2k.onrender.com/api/v1/product/update-products/${id}`, productData, {
                headers: {
    ...
    const deleteProduct = async () => {
        try {
            ...
            const { data } = await axios.delete(`https://api-to2k.onrender.com/api/v1/product/delete-product/${id}`)
                    ...
                    <div>
                        ...
                        <div className='m-5 flex justify-center'>
                            {photo ? (
                                ...
                                <div className='text-center'>
                                    <img src={`https://api-to2k.onrender.com/api/v1/product/get-productphoto/${id}`} alt="Product-photo" width={'200px'} />
                                </div>
                            )}
                        </div>
