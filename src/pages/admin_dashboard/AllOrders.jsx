...
const AllOrders = () => {
    ...
    const getAllOrders = async () => {
        try {
            const { data } = await axios.get('https://api-to2k.onrender.com/api/v1/product/orders', {
                headers: {
    ...
    const handleStatusChange = async (orderId, value) => {
        try {
            const { data } = await axios.put(`https://api-to2k.onrender.com/api/v1/product/order-status/${orderId}`, { status: value }, {
                headers: {
                    Authorization: parseData?.token
                }
            });
    ...
    const allowForEdit = async (orderId, value) => {
        try {
            const { data } = await axios.put(`https://api-to2k.onrender.com/api/v1/product/allow-edit/${orderId}`, { allowedStatus: value }, {
                headers: {
                    Authorization: parseData?.token
                }
            })
    ...
    const handleDeleteOrder = async (orderId) => {
        try {
            const { data } = await axios.delete(`https://api-to2k.onrender.com/api/v1/product/order/${orderId}`, {
                headers: {
                    Authorization: parseData?.token
                }
            });
